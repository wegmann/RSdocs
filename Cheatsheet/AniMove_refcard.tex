...
\begin{tabular}{@{}p{\the\MyLen}%
                @{}p{\linewidth-\the\MyLen}@{}}
                & \\
get\_imconvert() & Checks, downloads and/or installs ImageMagick needed to create GIF files
 \\

 & \\
animate\_move() & animating of movement and environmental data \\
animate\_stats() & animating of movement and environmental data statistics \\
&

...
\hypersetup{%
  ...
  pdfpagemode=UseNone, 
  pdfstartview=FitH,
  pdfauthor= {AniMove R reference card based on work by Jonas Stein, Tom Short, Emanuel Paradis},
  pdftitle= AniMove R Reference Card
}
...
\bcode{methods(a)} e.g. methods(summary) gives all summary commands
...
\section{Information about your data}
\everypar={\hangindent=9mm}
...
% \begin{center}
%  \includegraphics[width=.3\textwidth]{/home/wegmann/Pictures/presentations/Presentation_Images/rectangle_skull_buffalo.jpg}
...
% \begin{center}
%  \includegraphics[width=.3\textwidth]{pics/earth-observation_org_WegmannBevanda_rhino}
%  % zebra_crop_ppt.png: 1006x872 pixel, 72dpi, 35.49x30.76 cm, bb=0 0 1006 872
% \end{center}
...
% \begin{center}
%  \includegraphics[width=.3\textwidth]{pics/animove_org_WegmannBevanda_zebra_africa_dbb_light}
%  % zebra_crop_ppt.png: 1006x872 pixel, 72dpi, 35.49x30.76 cm, bb=0 0 1006 872
% \end{center}

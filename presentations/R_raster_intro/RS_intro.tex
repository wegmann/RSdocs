...
%Logo der Uni:
    \begin{tabular*}{\paperwidth}[b]{p{34em}rr}
         \vskip-2em
          \leftskip-2.88em     \includegraphics[height=.7cm]{unilogo.jpg} \hspace{0.2cm} \includegraphics[height=.7cm]{dlr.jpg} %\hspace{0.2cm} \includegraphics[height=.7cm]{mpi_logo2.jpg} \hspace{0.2cm} \includegraphics[height=.7cm]{enb} \hspace{0.2cm} \includegraphics[height=.7cm]{Smithsonian_large.jpg} \hspace{0.2cm} \includegraphics[height=.7cm]{ZSL_black.jpg} \hspace{0.2cm} \includegraphics[height=.7cm,clip=true,trim=0 0 0 0]{gce.jpg}  \hspace{0.2cm} \includegraphics[height=.7cm,clip=true,trim=0 0 0 0]{amnh.jpg}
          &  &           
    \end{tabular*}

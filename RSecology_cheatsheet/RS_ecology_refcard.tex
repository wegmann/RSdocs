...
\begin{center}
 \includegraphics[width=.17\textwidth]{pics/bookcoverwegmann.png}
...
\begin{tabular}{@{}p{\the\MyLen}%
                @{}p{\linewidth-\the\MyLen}@{}}
 &  \\                
xxx() & stack different raster layers together \\
xx(); dropLayer()	& add/drop a raster layer\\
xx() 		& crop raster set to smaller extent  \\
...
compiled by: Martin Wegmann (martin.wegmann@ecosens.org) and Benjamin Leutner (benjamin.leutner@ecosens.org) \\ \THEYEAR	
